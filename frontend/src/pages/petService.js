...
import { getAllServices } from "../api/productApi"
        ...
        <>
            ...
            <div className="my-8 mx-20">
                <div className="flex flex-row rounded bg-[#ededed] items-center px-4">
                    ...
                    <p className="text-[#333] px-3">Phụ kiện</p>
                </div>
                ...
                <div className="mt-20 flex flex-row gap-x-8">
                    ...
                    <div className={`${viewoptions? "flex flex-wrap justify-between w-3/4 flex-row": 'flex flex-wrap justify-between w-3/4 flex-col gap-y-4'}`}>
                        {petservice.map((item) => (
                            ...
                            >
                                <a href={`/petService/${item.id}`} className={`${viewoptions? "block h-3/4 group overflow-hidden relative": "block w-60 mr-8 group overflow-hidden relative"}`}>
