...
const Footer = () => {
    return (
        <div className="w-full pt-10 mt-10 pb-4 bg-fuchsia-100">
                ...
                <div className="w-3/4 flex flex-row justify-between mr-20">
                    ...
                    <div className="flex flex-col gap-y-2">
                        ...
                        <div className="flex flex-row gap-x-4">
                            <a href="https://www.facebook.com/" className="cursor-pointer p-1 shadow-lg rounded-lg transition ease-in-out hover:-translate-y-1 hover:scale-110">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
                                    <path d="M32 16c0-8.839-7.167-16-16-16-8.839 0-16 7.161-16 16 0 7.984 5.849 14.604 13.5 15.803v-11.177h-4.063v-4.625h4.063v-3.527c0-4.009 2.385-6.223 6.041-6.223 1.751 0 3.584 0.312 3.584 0.312v3.937h-2.021c-1.984 0-2.604 1.235-2.604 2.5v3h4.437l-0.713 4.625h-3.724v11.177c7.645-1.199 13.5-7.819 13.5-15.803z"></path>
                                </svg>
                            </a>

                            <a href="https://twitter.com/" className="cursor-pointer p-1 shadow-lg rounded-lg transition ease-in-out hover:-translate-y-1 hover:scale-110">
                            ...
                            <a href="https://www.instagram.com/" className="cursor-pointer p-1 shadow-lg rounded-lg transition ease-in-out hover:-translate-y-1 hover:scale-110">
